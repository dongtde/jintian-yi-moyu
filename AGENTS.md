...
- For any game development work in this repository, including gameplay systems, project structure, feature implementation, UI flow, asset workflow, playtesting, or architecture decisions, use `$game-studio` first as the umbrella development skill before routing to any more specific skill.
